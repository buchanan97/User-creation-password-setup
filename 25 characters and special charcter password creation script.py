#user credntials creation script with 25 characters and special character password requirements
def user_account_creation():
    ...
    while True:
        if len(user_password) != 25: # Check if password is 25 characters long
